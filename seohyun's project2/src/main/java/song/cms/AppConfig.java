...
@Configuration
@PropertySource("classpath:/song/cms/conf/security.properties")
@MapperScan("song.cms.dao")
...
public class AppConfig {
  ...
  public SqlSessionFactory sqlSessionFactory(
    ...
    try {
      ...
      factory.setTypeAliasesPackage("song.cms.domain");

      // SQL 맵퍼 파일 경로를 등록한다.
      factory.setMapperLocations(appCtx.getResources(
          "classpath:/song/cms/mapper/**/*.xml"));
